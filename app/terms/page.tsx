    ...
    <main className="min-h-screen">
      ...
      <article className="mx-auto max-w-3xl px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="space-y-12 text-base leading-relaxed text-ink-soft">
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Eligibility and Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Your Content and License</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">AI Guided Feedback</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Acceptable Use</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Subscriptions and Payments</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-ink mb-4">Governing Law and Disputes</h2>
            <p>
